...
mcopy -i efi.part /usr/share/grub2/x86_64-efi/grub.efi ::EFI/BOOT/bootx64.efi
...
# Add an extra MB at the end of the disk for the gpt headers, in fact 34 sectors would be enough, adding some more does not hurt.
truncate -s "+$((1024*1024))" disk.raw

# Create the partition table in disk.raw
