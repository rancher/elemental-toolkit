...
func MirrorData(log v2.Logger, runner v2.Runner, fs v2.FS, source string, target string, excludes ...string) error {
...
func rsyncWrapper(log v2.Logger, runner v2.Runner, fs v2.FS, source string, target string, flags []string) error {
	if fs != nil {
